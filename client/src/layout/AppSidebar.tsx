...
function ResponsiveMenu() {
    ...
    return (
        <>
            ...
            <div className="hidden sm:flex fixed left-10 flex-col gap-2.5 p-4 bg-white rounded-3xl shadow text-black w-[65px]">
            ...
            {/* Mobile Bottom Bar */}
            <div className="sm:hidden fixed bottom-0 left-0 w-full bg-white flex justify-around items-center py-2 px-1 shadow text-black z-50 rounded-t-xl">
                {menuItems.map((item, idx) => {
                    const Icon = item.icon;
                    const isActive = idx === activeIndex;
