...
export const AddOnCard = ({ addon }: { addon: IAddOn }) => {
    ...
    return (
        ...
        >
            ...
            {addons?.some((addonId:string)=>addon?._id==addonId)?
            ...
            <div onClick={()=>{dispatch(setAddons(addon?._id))}} className="absolute bottom-2 right-2 bg-white p-3 xs:p-2 rounded-full cursor-pointer">
