...
import { addAlladdonsAction, deleteaddonAction } from "../../../features/admin/addOnSlice";
import { deleteAddOn, getAllAddOnes } from "../../../services/adminService";
                ...
                <div className="max-w-full overflow-x-auto">
                    <Table>
                        ...
                        <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
                            {addons?.map((obj: IAddOn) => {
                                return (
                                    <TableRow key={obj?._id}>
                                        ...
                                        <TableCell className="px-4 py-3 text-gray-500 text-start text-theme-sm dark:text-gray-400">
                                            <select name="" value={obj?.isActive ? "active" : "inactive"} id="">
                            ...
                            {/* Repeat this block for more static rows if needed */}
                        </TableBody>
                    </Table>
                </div>
            </div>
