...
import packageSelectionReducer from "../features/user/packageSelectionSlice";
...
export interface IRootState {
    ...
    packageSelectionData: Record<string, any>;
}
...
export const store = configureStore({
    reducer: {
        ...
        addons: addonReducer,
        packageSelectionData: packageSelectionReducer,
    },
});
